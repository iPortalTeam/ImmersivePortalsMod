...
- 🟡 **IMPT000008:** Ripristinato target Minecraft 1.21.10 con versioni Fabric/Iris/Sodium compatibili *(2025-12-22 00:10:00)* [CHG] — Scope: gradle.properties, src/main/resources/fabric.mod.json, project.md, changelog.md — Reason: evitare rotture del nuovo render pipeline 1.21.11 che impediscono la build — Test: ./gradlew build — Rollback: ripristinare 1.21.11 e le versioni dipendenti in gradle.properties e fabric.mod.json
- 🟡 **IMPT000009:** Aggiornati i riferimenti a ResourceLocation/Util e primi adattamenti Optional NBT *(2025-12-22 01:05:00)* [CHG] — Scope: src/main/java/qouteall/imm_ptl/core, src/main/java/qouteall/imm_ptl/peripheral, src/main/java/qouteall/q_misc_util, project.md, changelog.md — Reason: allineare le importazioni/method name alle signature 1.21.10 — Test: ./gradlew build — Rollback: ripristinare gli import Identifier/Util e le letture NBT non-optional
