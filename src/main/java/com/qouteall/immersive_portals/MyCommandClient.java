    ...
    public static void register(
        ...
        builder = builder.then(CommandManager
            ...
            .executes(context -> {
                ...
                Helper.serverLog(context.getSource().getPlayer(), "Portal{" +
                    "id=" + collidingPortal.getEntityId() +
                    ", in=" + collidingPortal.dimension + collidingPortal.getBlockPos() +
                    ", to=" + collidingPortal.dimensionTo + new BlockPos(collidingPortal.destination) +
                    ", normal=" + new BlockPos(collidingPortal.getNormal()) +
                    '}');
                return 0;
            })
        );
