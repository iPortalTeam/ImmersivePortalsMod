...
public class ImplRemoteProcedureCall {
    ...
    static {
        ...
        serializerMap = ImmutableMap.<Class, BiConsumer<PacketByteBuf, Object>>builder()
            ...
            .put(Block.class, (buf, o) -> serializeByCodec(buf, Registry.BLOCK.method_39673(), o))
            .put(Item.class, (buf, o) -> serializeByCodec(buf, Registry.ITEM.method_39673(), o))
        ...
        deserializerMap = ImmutableMap.<Type, Function<PacketByteBuf, Object>>builder()
            ...
            .put(Block.class, buf -> deserializeByCodec(buf, Registry.BLOCK.method_39673()))
            .put(Item.class, buf -> deserializeByCodec(buf, Registry.ITEM.method_39673()))
